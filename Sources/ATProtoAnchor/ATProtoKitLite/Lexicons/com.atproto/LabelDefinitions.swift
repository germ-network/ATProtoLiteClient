...
extension ComAtprotoLexiconLite {
	...
	public struct LabelDefinition: Sendable, Codable, Equatable, Hashable {
		...
		public init(from decoder: any Decoder) throws {
			...
			self.isNegated = try container.decodeIfPresent(
				Bool.self, forKey: .isNegated)
			self.timestamp = try container.decodeDateLite(forKey: .timestamp)
			self.expiresOn = try container.decodeDateIfPresentLite(forKey: .expiresOn)
			self.signature = try container.decodeIfPresent(
				Data.self, forKey: .signature)
		}
		...
		public func encode(to encoder: Encoder) throws {
			...
			try container.truncatedEncodeLite(
				self.name, forKey: .name, upToCharacterLength: 128)
			try container.encodeIfPresent(self.isNegated, forKey: .isNegated)
			try container.encodeDateLite(self.timestamp, forKey: .timestamp)
			try container.encodeDateIfPresentLite(self.expiresOn, forKey: .expiresOn)
	...
	public struct SelfLabelsDefinition: Sendable, Codable, Equatable, Hashable {
		...
		public init(values: [SelfLabelDefinition], type: String?) {
			self.values = values
			self.type = type
		}
		...
		public init(from decoder: Decoder) throws {
			...
			self.values = try container.decode(
				[SelfLabelDefinition].self, forKey: .values)
		...
		public func encode(to encoder: Encoder) throws {
			...
			try container.truncatedEncodeLite(
				self.values, forKey: .values, upToArrayLength: 10)
	...
	public struct SelfLabelDefinition: Sendable, Codable, Equatable, Hashable {
		...
		public func encode(to encoder: Encoder) throws {
			...
			try container.truncatedEncodeLite(
				self.value, forKey: .value, upToCharacterLength: 128)
		}
	...
	public struct LabelValueDefinition: Sendable, Codable, Equatable, Hashable {
		...
		public func encode(to encoder: any Encoder) throws {
			...
			try container.truncatedEncodeLite(
				self.identifier.transformToLowerASCIIAndHyphen(),
				forKey: .identifier, upToCharacterLength: 100)
	...
	public struct LabelValueDefinitionStringsDefinition: Sendable, Codable, Equatable, Hashable
	{
		...
		public init(from decoder: any Decoder) throws {
			...
			self.language = try container.decodeLocaleLite(forKey: .language)
			self.name = try container.decode(String.self, forKey: .name)
		...
		public func encode(to encoder: any Encoder) throws {
			...
			try container.truncatedEncodeLite(
				self.name, forKey: .name, upToCharacterLength: 64)
			try container.truncatedEncodeLite(
				self.description, forKey: .description, upToCharacterLength: 10_000)
		}
